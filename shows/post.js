function(doc, req) {  
  ...
  return { code : 200, headers : { 
    ...
    body: '<html>' +
      ...
      '</head>'+
      '<body onclick="location.href='+"'https://yolkyolk.iriscouch.com/nothingbetweenus/_design/nothingbetweenus/index.html'"+';" style="cursor:pointer;box-sizing:border-box;'+doc.style+'">'+
